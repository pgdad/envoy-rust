...
- Commit: 9324506 (main); 19ef581 (support — thiserror bump + deny.toml wildcard handling); <SHA-of-this-fix-commit> (re-review fix — deny.toml tightened to allow-wildcard-paths idiom + this PROGRESS entry).
