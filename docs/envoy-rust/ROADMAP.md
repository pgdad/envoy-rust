...
| 05 | HTTP/2 downstream + upstream (low-level framer, own conn mgr) | 04 | in-progress | 05.1, 05.2, 05.3, 05.4 | HTTP/2 fixture green; `h2spec` above threshold |
