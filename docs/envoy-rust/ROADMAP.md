...
| 07 | Filter chain framework: iteration protocol, per-route config, extension registry | 06 | in-progress | — | framework fixtures green; trivial pluggable filter covers all iteration states |
