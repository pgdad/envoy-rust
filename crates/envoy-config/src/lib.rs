...
pub use bootstrap::{
    ...
    HeaderToMetadataKeyValue, HeaderToMetadataRule, HeaderToMetadataType, HeaderValue,
    ...
    Listener, LoadAssignment, LocalRateLimitConfig, LocalityLbEndpoints, MetadataEntry, Mutations,
    NetworkFilter, Node, OutlierDetection, PathConfigSource, PerFilterConfig, Percent, Permission,
