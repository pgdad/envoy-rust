...
pub use bootstrap::{
    ...
    FileAccessLog, FilterChain, FilterChainMatch, FractionalPercent, HeaderMatcher,
    HeaderMatcherMode, HeaderMutationConfig, HeaderMutationEntry, HeaderValue, HeaderValueOption,
    HealthCheck, Http1ProtocolOptions, Http2ProtocolOptions, HttpConnectionManagerConfig,
    HttpFilter, HttpFilterTypedConfig, HttpHealthCheck, HttpProtocolOptions, HttpStatus,
    Int64Range, JwtAuthnConfig, JwtProvider, JwtRequirement, LbEndpoint, LbPolicy, Listener,
    LoadAssignment, LocalRateLimitConfig, LocalityLbEndpoints, Mutations, NetworkFilter, Node,
