...
pub use bootstrap::{
    ...
    Mutations, NetworkFilter, Node, OutlierDetection, PathConfigSource, PerFilterConfig, Percent,
    Permission, PermissionSet, Policy, Principal, PrincipalSet, RbacConfig, Rds, RequirementRule,
    RetryConfig, RetryOn, RetryPolicy, Route, RouteAction, RouteAction_Route, RouteConfiguration,
    RouteMatch, RouterConfig, RoutingPriority, Rules, RuntimeFractionalPercent, SafeRegex,
    SocketAddress, StaticResources, StringMatcher, StringMatcherMode, TcpProxyConfig, Thresholds,
